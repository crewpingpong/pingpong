...
-- 회원가입 (시퀀스, 이메일, 비번, 닉넴, url, DEFAULT(가입일), DEFAULT(탈퇴여부), DEFAULT(권위))
INSERT INTO	"MEMBER" VALUES(SEQ_MEMBER_NO.NEXTVAL, 'pingpong123@kh.or.kr', '123', '핑퐁', 'pingpong123', DEFAULT, DEFAULT, DEFAULT);

INSERT INTO	"MEMBER" VALUES(SEQ_MEMBER_NO.NEXTVAL, '123123@123123.com', '123123', '123123'
	, '123123', DEFAULT, DEFAULT, DEFAULT);
--"MEMBER_NO"
--"MEMBER_EMAIL"
--"MEMBER_PW"
--"MEMBER_NICKNAME"
