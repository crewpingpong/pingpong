...
UPDATE "MEMBER" SET
MEMBER_PW = '$2a$10$pzG4tu/GiJV6mB8GIyV6huM1fKWR2taLbhdTiQHaHxinaetTJnn4i'
WHERE MEMBER_NO = 1 ;
...
UPDATE "MEMBER" SET
MEMBER_NICKNAME = '핑핑퐁',
MEMBER_URL = 'pingpong1234@kh.or.kr'
WHERE MEMBER_NO = 1;
...
INSERT INTO	"MEMBER" VALUES(SEQ_MEMBER_NO.NEXTVAL, 'apfhd@kh.or.kr', '123', '메롱', 'apfhdapfhd', DEFAULT, DEFAULT, DEFAULT);
COMMIT;
...
ALTER TABLE INQUIRY DROP COLUMN INQUIRY_IMAGE;
...
ALTER TABLE "INQUIRY_IMG" ADD CONSTRAINT "PK_INQUIRY_IMG" PRIMARY KEY (
	"IMG_NO"
);

COMMENT ON COLUMN "INQUIRY_IMG"."IMG_NO" IS '이미지 번호(SEQ_INQUIRY_IMG_NO)';

COMMENT ON COLUMN "INQUIRY_IMG"."IMG_ORDER" IS '이미지 순서';

COMMENT ON COLUMN "INQUIRY_IMG"."IMG_ADDRESS" IS '이미지 주소';

COMMENT ON COLUMN "INQUIRY_IMG"."INQUIRY_NO" IS '문의 번호';

CREATE SEQUENCE SEQ_INQUIRY_IMG_NO NOCACHE;
