...
UPDATE "MEMBER" SET
MEMBER_PW = '$2a$10$2Bv6Kl6RDpCkxhnr5V8JbeJ2igmHo8/4MxZGz9uQWN2usqWVZaK0.'
WHERE MEMBER_NO = 1;
...
-- 사람 검색
SELECT MEMBER_NO , MEMBER_EMAIL  ,MEMBER_NICKNAME , MEMBER_NICKNAME  FROM "MEMBER"
WHERE LOWER(MEMBER_NICKNAME) LIKE '%aaa%'
AND MEMBER_DEL_FL = 'N'
AND ROWNUM <= 40;
