...
public class EmailServiceImpl implements EmailService {
    ...
    private String fromEmail = "ckcc0813@gmail.com";
    private String fromUsername = "PingPong";
    ...
    public int signUp(String email, String title) {
        ...
        try {
            ...
            // 제목
            String subject = "[PingPong]"+title+" 인증코드";
	...
	@Override
	public int pwSearchCertNum(String email, String title) {
		//6자리 난수 인증번호 생성
        String authKey = createAuthKey();
        try {
