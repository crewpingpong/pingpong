            ...
            <div class="profileLeft"> <!-- 프로필 사진 있는 구역 -->
                ...
                <div class="profileBtn">
                    ...
                    <div class="followBtn"> <!-- followshow 클래스 있으면 보임 -->
                        <svg class="nufollow followshow" width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg class="followUser" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            * */
            ...
            <!-- 하단 영역 -->
                ...
                <div class="BoardCommentBox">
                    ...
                    <a class="BoardComment" href="#">댓글 달기</a>
                </div>
                ...
                <div id="oneToOne">
                    ...
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <select name="BoardReport" id="" required>
                            ...
                            <option value="">지식재산권</option>
                            <option value="">폭력 및 범죄 행위</option>
                            <option value="">불쾌한 콘텐츠</option>
                            <option value="">무결성 및 진실성</option>
    ...
    <div class="NewBoardBackground BoardBackground-close"> <!-- 새 게시글 불투명 배경 -->
        ...
        <div class="NewBoardMainContainer"> <!-- 새 게시글 하얀 배경 -->
            ...
            <div>
                ...
                <input id="ContentNewFile" type="file" multiple style="display: none;">
    ...
    <div class="BoardBackground2 BoardBackground-close" ><!-- 게시글 작성 불투명 배경 -->
        ...
        <div class="BoardMainContainer2"> <!-- 게시글 작성 하얀 배경 -->
            ...
            <div class="board-container-top">
                ...
                <!-- 공유 하기 -->
                <span class="new-borad-upload">공유 하기</span>
            </div>
            ...
            <div class="NewWriteBoardContainerRight"><!-- 게시글 작성 오른쪽 화면 -->
                ...
                <textarea class="NewWriteTextArea" maxlength="2000" cols="30" rows="10" placeholder="문구 입력.."></textarea>
